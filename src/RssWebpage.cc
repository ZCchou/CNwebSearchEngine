#include"../Include/RssWebpage.h"
void RssWebpage::parseRss(const string filepath){
...
//过滤html标签
string RssWebpage::htmlfilter(string line){
regex regAll("<[^>]+>");
...
void RssWebpage::dump(const string & filename){
...
vector<WebPage> RssWebpage::getWebData(){
return _rss;
}
